...
if __name__ == "__main__":
    ...
    with webdriver.Chrome(service=chrome_service, options=chrome_options) as driver:
        ...
        plzInput = driver.find_element(By.ID, 'adressInput')
        ...
        try:
            firstMarketInList = WebDriverWait(driver, 4).until(expected_conditions.element_to_be_clickable((By.XPATH, '/html/body/main/article/div/div/div/div[1]/div/div/div[2]/div/div/div[1]/ul/li[1]/a')))
